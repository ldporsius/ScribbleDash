...
import nl.codingwithlinda.scribbledash.core.presentation.design_system.theme.DustyBlue
...
class CanvasColorDustyBlue: CanvasColorProduct() {
    override val color: Int
        get() = DustyBlue.toArgb()
