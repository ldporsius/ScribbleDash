...
import nl.codingwithlinda.scribbledash.core.presentation.design_system.theme.LightGray
...
class CanvasColorLightGray: CanvasColorProduct() {
    override val color: Int
        get() = LightGray.toArgb()
