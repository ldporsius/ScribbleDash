...
import nl.codingwithlinda.scribbledash.core.presentation.design_system.theme.LightSageGreen
...
class CanvasColorLightSageGreen: CanvasColorProduct() {
    override val color: Int
        get() = LightSageGreen.toArgb()
