...
import nl.codingwithlinda.scribbledash.core.presentation.design_system.theme.PalePeach
...
class CanvasColorPalePeach: CanvasColorProduct() {
    override val color: Int
        get() = PalePeach.toArgb()
