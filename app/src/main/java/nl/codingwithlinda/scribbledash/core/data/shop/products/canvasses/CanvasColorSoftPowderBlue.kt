...
import nl.codingwithlinda.scribbledash.core.presentation.design_system.theme.SoftPowderBlue
...
class CanvasColorSoftPowderBlue: CanvasColorProduct() {
    override val color: Int
        get() = SoftPowderBlue.toArgb()
