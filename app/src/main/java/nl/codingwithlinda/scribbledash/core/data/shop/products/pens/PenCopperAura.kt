...
import nl.codingwithlinda.scribbledash.core.presentation.design_system.theme.CopperAura
...
class PenCopperAura(): BasicPenProduct() {
    override val color: Int
         = CopperAura.toArgb()
    override val id: String
        = this::class.java.simpleName
    override val title: UiText
        = UiText.DynamicText("CopperAura")
