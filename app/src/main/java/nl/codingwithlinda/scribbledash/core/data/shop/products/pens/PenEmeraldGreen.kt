...
import nl.codingwithlinda.scribbledash.core.presentation.design_system.theme.EmeraldGreen
...
class PenEmeraldGreen(): BasicPenProduct() {
    override val color: Int
         = EmeraldGreen.toArgb()
    override val id: String
        = this::class.java.simpleName
    override val title: UiText
        = UiText.DynamicText("EmeraldGreen")
