...
import nl.codingwithlinda.scribbledash.core.presentation.design_system.theme.FlameOrange
...
class PenFlameOrange(): BasicPenProduct() {
    override val color: Int
         = FlameOrange.toArgb()
    override val id: String
        = this::class.java.simpleName
    override val title: UiText
        = UiText.DynamicText("FlameOrange")
