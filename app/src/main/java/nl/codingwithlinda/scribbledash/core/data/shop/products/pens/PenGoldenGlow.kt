...
import nl.codingwithlinda.scribbledash.core.presentation.design_system.theme.GoldenGlow
...
class PenGoldenGlow(): BasicPenProduct() {
    override val color: Int
         = GoldenGlow.toArgb()
    override val id: String
        = this::class.java.simpleName
    override val title: UiText
        = UiText.DynamicText("GoldenGlow")
