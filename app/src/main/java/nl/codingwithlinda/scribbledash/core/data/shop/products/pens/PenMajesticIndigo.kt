...
import nl.codingwithlinda.scribbledash.core.presentation.design_system.theme.MajesticIndigo
...
class PenMajesticIndigo(): BasicPenProduct() {
    override val color: Int
         = MajesticIndigo.toArgb()
    override val id: String
        = this::class.java.simpleName
    override val title: UiText
        = UiText.DynamicText("MajesticIndigo")
